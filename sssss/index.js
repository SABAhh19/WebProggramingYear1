...
const confirmPPassword = document.querySelector(
  'input[name="confirmPassword"]',
);

const errorUsername = document.getElementById("error-username");
const errorPassword = document.getElementById("error-password");
const confirmPassword = document.getElementById("error-confirm-password");
...
form.addEventListener("submit", (event) => {
  ...
  if (confirmPPassword.value !== password.value) {
    setError(confirmPassword, confirmPPassword, "password needs to match");
  }
